...
module.exports = {
  ...
  SmartCardReaderData: {
    ...
    APDU_COMMAND: {
      ...
      MSE: {
        SET_DIGITAL_SIGNATURE: [0x00, 0x22, 0xF1, 0xB6, 0x03, 0x84, 0x01, 0x00],
      },
      PSO_CDS_PREFIX: [0x00, 0x2A],
      REMAINING_PIN_TRIES: [0x00, 0x20, 0x00, 0x10, 0x00],
      VERIFY_PIN: (asciiPin) => {
        const pinAsHex = asciiToHex(asciiPin);
        return [0x00, 0x20, 0x00, 0x10, pinAsHex.length, ...pinAsHex]
      }
    }
  }  
